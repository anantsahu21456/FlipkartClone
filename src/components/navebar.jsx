    ...
    <>
      <div className="navebarmaindiv">
        <ul className="navebarlist">
          <li><Link className="removelinkline" to='/All'> <img id="naveimg" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT2xNSEyyAbvtFXyDmRnfJZd6MafrVCKejZuQ&usqp=CAU" alt="" /> Surprise</Link></li>
